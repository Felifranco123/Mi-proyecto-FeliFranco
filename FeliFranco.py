...
nombre = st.text_input("Buenas, bienvenido a FelBot ¿Còmo te llamàs? ")

click = st.button("Saludar")

if click :
    st.write(f'Hola {nombre }. Un gusto. Este es un ChatBot llamado FelBot creado por Felipe Franco (poca creatividad en el nombre), quien es un estudiante de quìmica, que probablemente siga farmeceutica en la UBA. Disfruta tu estancia aquì')
